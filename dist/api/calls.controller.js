...
const calls_dto_1 = require("../structures/calls.dto");
let CallsController = class CallsController {
    constructor(manager) {
        this.manager = manager;
    }
    rejectCall(session, request) {
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Reject incoming call' }),
...
exports.CallsController = CallsController = __decorate([
    ...
    (0, common_1.Controller)('api/:session/calls'),
