...
exports.CallRejectedMessageHandler = exports.WAHACallRejectedConsumer = void 0;
...
let WAHACallRejectedConsumer = class WAHACallRejectedConsumer extends base_1.ChatWootWAHABaseConsumer {
    ...
    async Process(job, info) {
        ...
        const handler = new CallRejectedMessageHandler(job, container.MessageMappingService(), container.ContactConversationService(), container.Logger(), info, new WAHASelf_1.WAHASessionAPI(event.session, container.WAHASelf()), locale, container.WAHASelf());
        const msg = (0, call_0_base_1.BuildCallMessagePayload)(event.payload, enums_dto_1.WAHAEvents.CALL_REJECTED);
        return await handler.handle(msg);
    }
};
exports.WAHACallRejectedConsumer = WAHACallRejectedConsumer;
exports.WAHACallRejectedConsumer = WAHACallRejectedConsumer = __decorate([
    (0, bullmq_1.Processor)(QueueName_1.QueueName.WAHA_CALL_REJECTED, { concurrency: constants_1.JOB_CONCURRENCY }),
    __metadata("design:paramtypes", [manager_abc_1.SessionManager,
        nestjs_pino_1.PinoLogger,
        rmutex_service_1.RMutexService])
], WAHACallRejectedConsumer);
class CallRejectedMessageHandler extends base_1.MessageBaseHandler {
    async getMessage(payload) {
        var _a;
        const content = this.l
            .key(templates_1.TKey.WA_TO_CW_CALL_REJECTED)
            .render({ call: payload });
        let private_ = false;
        if (((_a = payload._data.Data) === null || _a === void 0 ? void 0 : _a.Tag) == 'reject') {
            private_ = true;
        }
    ...
    getReplyToWhatsAppID(payload) {
        return (0, call_0_base_1.BuildFakeCallMessageId)(payload.callId, enums_dto_1.WAHAEvents.CALL_RECEIVED);
    }
}
exports.CallRejectedMessageHandler = CallRejectedMessageHandler;
